package com.indarsoft.hps.examples.asn1;
 ...
 */
      ...
      System.out.println(  Binary.toHexStr(  os_encoded ) );
      System.out.println(  Binary.toPrintableString( os_encoded ));
      System.out.println(  "================== " );      
      byte[] os_octects = os.getOctets() ; 
      System.out.println(  Binary.toPrintableString( os_octects )) ;
      System.out.println(  Binary.toHexStr(  os_octects ) );      
      System.out.println(  Binary.toBitStr( os_encoded ) ); 
/*
 ...
 */
      ...
      System.out.println(  Binary.toHexStr(  os2_encoded ) );
      System.out.println(  Binary.toPrintableString( os2_encoded ));
      byte[] os2_header = Arrays.copyOfRange(os2_encoded, 0, 10 ); 
      System.out.println(  Binary.toBitStr( os2_header ) );    
/*
 ...
 */
      ...
      System.out.println(  Binary.toHexStr(  gs_encoded ) );
      System.out.println(  Binary.toPrintableString( gs_encoded ));
      System.out.println(  Binary.toBitStr( gs_encoded ) );  
/*
 ...
 */
      ...
      System.out.println(  Binary.toHexStr(  utf8s_encoded ) );
      System.out.println(  Binary.toPrintableString( utf8s_encoded ));
      System.out.println(  Binary.toBitStr( utf8s_encoded ) );
     }
}
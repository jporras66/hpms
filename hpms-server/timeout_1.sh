...
# timeout : amount in milliseconds ( aka 2000 is 2 seconds )
#
$JRE/bin/java -Dbroker.config=broker_properties.xml -Dinputqueue=REQ.SV1.TIMEOUT_1  -Doutputqueue=RES.SV1 -Dtimeout=2000 -Ddb.config=pgbouncer_properties.xml -cp  $JARFILES com.indarsoft.hps.TimeoutMessage
#